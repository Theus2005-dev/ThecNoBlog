  ...
  return (
    <div>
        <header className="bg-blue-500 flex justify-between h-15">
          ...
          <main className="flex flex-col items-center h-screen bg-red-500 text-center pt-10">   

            <div className="pt-20 cursor-pointer pb-10 rounded bg-white w-80 h-80">

                <h2 className="text-center">Login</h2>
                <Link href="/loginForm"><button className="bg-blue-500 cursor-pointer rounded w-50 h-10">Login</button></Link> <br/> <br/>
                <h2>Cadastro</h2>
